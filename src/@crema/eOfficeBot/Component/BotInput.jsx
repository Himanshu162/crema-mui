...
// const BotInput = () => {
//   const { addUserMsg } = useContext(BotContext);

//   const validationSchema = Yup.object({
//     userQuery: Yup.string().required("Message is required"),
//   });
...
//       />
//       {formik.touched.userQuery && formik.errors.userQuery ? (
//         <div>{formik.errors.userQuery}</div>
//       ) : null}
